...
var common = (function () {
    ...
    * named "listener".  这个embed是HTML5中添加的新标签
    *
    ...
    */
    ...
    function SendMessage(msg) {
        var listenerDiv = document.getElementById('nacl_module');
        listenerDiv.postMessage(msg);
    }
//    function SendMessage(msg, theCallBackFun) {
//        var listenerDiv = document.getElementById('nacl_module');
//        listenerDiv.postMessage(msg);
//        if (typeof theCallBackFun === "undefined" || theCallBackFun == null) {
//        }
//        else {
//            CallBackFun = theCallBackFun;
//        }
//    }
    ...
    */
    ...
    // The symbols to export.  javascript中的对象 数据类型
    return {
